            ...
            try:
                ...
                for c in self.app.chains_runtime:
                    ...
                    batch_lines.extend(self._build_lines_chain(
                        chain=c, t=t, freq=freq,
                        Av=Av, Ah=Ah, phi_v_deg=phi_v,
...
class PlotWindow(tk.Toplevel):
    def __init__(self, app):
        ...
        self.ptB, = self.ax.plot([], [], marker="x")  # B
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # Columna 1: Serial + módulos + mapa humedad (MOVIDO AQUÍ)
    ...
    def generate_humidity_map(self):
        ...
        Punticos en grilla con:
          - cuadrantes (valores fijos)
          - bloque rojo centrado en B (rojo sólido)
        ...
        # bloque rojo móvil centrado en B
        rect_w = w_rel * W
        rect_h = h_rel * H
    ...
    def start_all(self):
        ...
        # regenerar mapa para alinear bloque rojo con B actual
